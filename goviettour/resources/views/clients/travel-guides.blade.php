            ...
            <div class="col-xl-5 col-lg-6">
                <div class="mobile-app-content rmb-55" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="section-title counter-text-wrap mb-40">
                        <h2>GoVietTour <br>Hướng dẫn đầy đủ của bạn về các chuyến đi </h2>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/team/guide-diem.jpg') }}" alt="Guide">
                    <div class="content">
                        <h6>Trương Tấn Diệm</h6>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/team/guide-thanh.jpg') }}" alt="Guide">
                    <div class="content">
                        <h6>La O Thị Thanh</h6>
                        <span class="designation">Người sáng lập</span>
                        <div class="social-style-one inner-content">
                            <a href="contact"><i class="fab fa-twitter"></i></a>
                            <a href="contact"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500"
                    ...
                    <div class="content">
                        <h6>Trọng Hải</h6>
                        <span class="designation">Hướng dẫn viên chuyên nghiệp</span>
                        <div class="social-style-one inner-content">
                            <a href="contact"><i class="fab fa-twitter"></i></a>
                            <a href="contact"><i class="fab fa-facebook-f"></i></a>
                            <a href="contact"><i class="fab fa-instagram"></i></a>
