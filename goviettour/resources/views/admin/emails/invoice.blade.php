...
<p style="font-size: 16px; font-family: Arial, sans-serif; color: #333;">Cảm ơn bạn đã đặt tour tại GoVietTour. Vui lòng xem chi tiết hóa đơn trong file đính kèm.</p>
            ...
            <div class="row invoice-info" style="margin-bottom: 20px;">
                ...
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
                    ...
                    <address>
                        ...
                        <br>01 Phù Đổng Thiên Vương
                        <br>Phường 8, Thành phố Đà Lạt, Tinh Lâm Đồng
                        <br>Phone: 1 (804) 123-9876
                        <br>Email: goviettour@gmail.com
                    </address>
                </div>
                <br>
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
